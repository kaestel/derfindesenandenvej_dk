...
<? } else { ?>
	<link type="text/css" rel="stylesheet" media="all" href="/css/seg_<?= $this->segment() ?>.css?rev=20230315-194236" />
	<script type="text/javascript" src="/js/seg_<?= $this->segment() ?>.js?rev=20230315-194236"></script>
<? } ?>
